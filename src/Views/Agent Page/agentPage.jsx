    ...
    useEffect(() => {
        const fetchAgentData = async () => {
            try {
                ...
                const selectedAgent = agents[0]; // directly pick the only agent
                ...
                <div className="bg-[#1D1F24] rounded-xl overflow-hidden shadow-lg">
                    ...
                    <div className="relative h-72 md:h-96 bg-gradient-to-r from-[#0EA5E9] to-[#6366F1]">
                        ...
                        <div className="absolute bottom-0 left-0 p-6 md:p-8 w-full">
                            ...
                            <h1 className="text-4xl md:text-5xl font-bold text-[#F9FAFB] drop-shadow-md">{agent.NAME}</h1>
                        </div>
                    </div>
                        ...
                        <div className="flex flex-col lg:flex-row gap-8">
                            ...
                            <div className="lg:w-2/3">
                                ...
                                <div className="mb-8 bg-[rgba(18,19,23,0.2)] p-6 rounded-xl">
                                    <h2 className="text-2xl font-bold mb-4 text-[#F9FAFB] border-b border-[rgba(156,163,175,0.1)] pb-2">About this Agent</h2>
                                    <p className="text-[#9CA3AF] mb-4 text-lg">{agent.DESCRIPTION}</p>
                                ...
                                <div className="mb-8 bg-[rgba(18,19,23,0.2)] p-6 rounded-xl">
                                    ...
                                    <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        {agent.FEATURES.map((feature, index) => (
                                            <li key={index} className="flex items-start bg-[rgba(18,19,23,0.3)] p-3 rounded-lg">
                                ...
                                {agent.USE_CASES && (
                                    <div className="mb-8 bg-[rgba(18,19,23,0.2)] p-6 rounded-xl">
                                        <h2 className="text-2xl font-bold mb-4 text-[#F9FAFB] border-b border-[rgba(156,163,175,0.1)] pb-2">Use Cases</h2>
                                ...
                                {agent.REVIEWS && agent.REVIEWS.length > 0 && (
                                    <div className="mb-8 bg-[rgba(18,19,23,0.2)] p-6 rounded-xl">
                                        <h2 className="text-2xl font-bold mb-4 text-[#F9FAFB] border-b border-[rgba(156,163,175,0.1)] pb-2">User Reviews</h2>
                                        <div className="space-y-4">
                                            {agent.REVIEWS.map((review, index) => (
                                                <div key={index} className="bg-[rgba(18,19,23,0.4)] p-4 rounded-lg">
                                                    <div className="flex justify-between items-center mb-2">
                                                        <span className="font-medium text-[#F9FAFB] text-lg">{review.USER}</span>
                            ...
                            <div className="lg:w-1/3">
                                ...
                                <div className="bg-[rgba(18,19,23,0.4)] p-6 rounded-xl mb-6 sticky top-8">
                                    <h3 className="text-xl font-bold mb-4 text-[#F9FAFB]">Get Started Now</h3>
                                    <p className="text-[#9CA3AF] mb-6">Add this agent to your workspace and start boosting your productivity.</p>
                                    <button 
                                        onClick={handleGetAgent}
                                    ...
                                    <p className="text-xs text-center text-[#9CA3AF]">One-time payment, no subscription</p>
                                </div>
                                ...
                                <div className="bg-[rgba(18,19,23,0.4)] p-6 rounded-xl mb-6">
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex items-center">
                                            ...
                                            <span className="text-[#F9FAFB] font-medium">{agent.VERSION}</span>
                                        </div>
                                        <div className="flex items-center">
                                            <FaCalendarAlt className="text-[#9CA3AF] mr-3" />
                                            <span className="text-[#9CA3AF] mr-2 w-24">Released:</span>
                                            <span className="text-[#F9FAFB] font-medium">{agent.RELEASE_DATE}</span>
                                        </div>
                                        <div className="pt-2">
                                            <span className="text-[#9CA3AF] block mb-2">Requirements:</span>
                                            <span className="text-[#F9FAFB] bg-[rgba(18,19,23,0.6)] p-2 rounded block">{agent.REQUIREMENTS}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-[rgba(18,19,23,0.4)] p-6 rounded-xl">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {agent.TAGS.map((tag, index) => (
                                            <span key={index} className="bg-[rgba(156,163,175,0.1)] px-3 py-2 rounded-lg text-sm text-[#9CA3AF] hover:bg-[rgba(156,163,175,0.2)] transition cursor-pointer">
                                                {tag}
                                            </span>
                                        ))}
                                    </div>
